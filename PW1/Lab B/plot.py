...
t, observed = np.loadtxt("decay_observed.csv", 
...
#         label the axes.
# Create 1 row, 2 columns of plots, sharing both axes
fig, (ax1, ax2) = plt.subplots(1, 2, sharex=True, sharey=True, figsize=(10, 5))

# Left plot: observed data as points (scatter)
ax1.scatter(t, observed, color='blue', marker='o')
ax1.set_title("Observed Decay")
ax1.set_xlabel("Time (s)")
ax1.set_ylabel("Atom Count")

# Right plot: analytical law as a smooth line (plot)
ax2.plot(t, analytical, color='red')
ax2.set_title("Analytical Law")
ax2.set_xlabel("Time (s)")
ax2.set_ylabel("Atom Count")
